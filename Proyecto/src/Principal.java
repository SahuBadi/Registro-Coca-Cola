...
public class Principal extends JFrame implements ActionListener{
    ...
    private JTextField txtNombreTrabajador, txt1ApellidoTrabajador, txt2ApellidoTrabajador;
    ...
    public Principal(){
        ...
        miElCreador.setFont(new Font("Nadale Mono",1,14));
        ...
        label1Apellido.setFont(new Font("Andale Mono",1,12));
        label1Apellido.setForeground(new Color(255,255,255));
        add(label1Apellido);

        txt1ApellidoTrabajador = new JTextField();
        txt1ApellidoTrabajador.setBounds(25,273,150,25);
        txt1ApellidoTrabajador.setBackground(new java.awt.Color(224,224,224));
        txt1ApellidoTrabajador.setFont(new java.awt.Font("Andale Mono",1,14));
        txt1ApellidoTrabajador.setForeground(new java.awt.Color(255,0,0));
        add(txt1ApellidoTrabajador);

        label2Apellido = new JLabel("Segundo Apellido:");
        label2Apellido.setBounds(25,308,180,25);
        label2Apellido.setFont(new Font("Andale Mono",1,12));
        label2Apellido.setForeground(new Color(255,255,255));
        add(label2Apellido);

        txt2ApellidoTrabajador = new JTextField();
        txt2ApellidoTrabajador.setBounds(25,334,150,25);
        txt2ApellidoTrabajador.setBackground(new java.awt.Color(224,224,224));
        txt2ApellidoTrabajador.setFont(new java.awt.Font("Andale Mono",1,14));
        txt2ApellidoTrabajador.setForeground(new java.awt.Color(255,0,0));
        add(txt2ApellidoTrabajador);
        ...
        comboDepartamento.setBackground(new java.awt.Color(224,224,224,224));
    ...
    public void actionPerformed(ActionEvent e){
        if (e.getSource() == miCalculo){
            ...
            String PA = txt1ApellidoTrabajador.getText();
            String SA = txt2ApellidoTrabajador.getText();
            String Departamento = comboDepartamento.getSelectedItem().toString();
            String Antiguedad = comboAntiguedad.getSelectedItem().toString();
            if(nombreTrabajador.equals("") || PA.equals("") || SA.equals("") ||
                ...
                if(Departamento.equals("Atención al Cliente")){
                    if(Antiguedad.equals("1 año de servicio")){
                        textarea1.setText("\n   El trabajador "+nombreTrabajador+" "+PA+" "+SA+
        ...
        if (e.getSource() == miNuevo){
            ...
            txt1ApellidoTrabajador.setText("");
            txt2ApellidoTrabajador.setText("");
        ...
        if (e.getSource() == miElCreador){
            JOptionPane.showMessageDialog(null,"   Desarrollado por Delia S.B. \n"+
                                                                        "   correo electrónico: mdsahuquillo@gmail.com");
        }
    }
